...
<aside class="h-screen w-64 fixed left-0 top-0 hidden md:flex flex-col p-md gap-base bg-surface-container-lowest border-r border-outline-variant z-40" id="sidebar">
...
<a class="flex items-center gap-sm p-sm bg-secondary-container text-on-secondary-container rounded-lg font-bold transition-all duration-200" href="#">
<span class="material-symbols-outlined">dashboard</span>
<span class="font-label-md text-label-md">Dashboard</span>
</a>
<a class="flex items-center gap-sm p-sm text-on-surface-variant hover:bg-surface-container-high rounded-lg transition-all" href="#">
...
<a class="flex items-center gap-sm p-sm text-error hover:bg-error-container/20 rounded-lg transition-all" href="#">
...
<header class="w-full h-16 sticky top-0 z-50 bg-surface shadow-sm md:ml-64 md:w-[calc(100%-16rem)] flex justify-between items-center px-margin-mobile md:px-margin-desktop">
...
<div class="h-10 w-10 rounded-full bg-primary-fixed-dim flex items-center justify-center text-primary font-bold overflow-hidden cursor-pointer">
<img class="w-full h-full object-cover" data-alt="A professional portrait of a high-net-worth client, looking confident and serene, with a soft-focus minimalist interior office background. The lighting is sophisticated and warm, aligning with the premium AuraWealth brand identity of quiet luxury and institutional stability. The color palette features soft neutrals and deep emerald tones." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDV2JyOY01g6HPPbLe_n3pss7Ty7aXSG-ec_D30rhtOMsfzgSgrEIT8Dqv7Use1ftRMRotoJptpCpWjorWVqmmbezUs4tWf_theXFc99jTv3-YHwr5z9AFGXXdBTNpam1RkCqZMesreJ7Jo8wxHHz1Gf0qbEa-MwtICMKf7rLE8Y5g8n9JbnqGxCb0mTUAS307zoRm0gbwHCUtrClzlPtQXcU0CbKcUo-ASVaKj4WG2iFheYFY5vPEr"/>
</div>
</div>
</header>
<!-- Main Content Canvas -->
...
<div class="lg:col-span-2 relative overflow-hidden rounded-xl bg-primary text-on-primary p-xl shadow-lg group">
...
<button class="w-full py-sm text-primary font-label-md flex items-center justify-center gap-xs hover:bg-surface-container-low transition-all rounded-lg mt-md">
...
<button class="group flex flex-col items-center justify-center gap-sm p-xl rounded-xl border border-outline-variant hover:border-primary hover:shadow-md transition-all duration-200">
...
<div class="space-y-1">
<!-- Item 1 -->
<div class="flex items-center justify-between p-sm hover:bg-surface-container-low rounded-lg transition-colors cursor-pointer group">
...
<!-- Item 2 -->
<div class="flex items-center justify-between p-sm hover:bg-surface-container-low rounded-lg transition-colors cursor-pointer">
<div class="flex items-center gap-md">
<div class="w-10 h-10 rounded-full bg-tertiary-container/10 flex items-center justify-center text-on-tertiary-container">
<span class="material-symbols-outlined">payments</span>
</div>
<div>
...
<div class="bg-secondary-fixed text-on-secondary-fixed rounded-xl p-md border border-outline-variant/30 flex flex-col gap-base">
...
<button class="mt-md px-md py-sm bg-on-secondary-fixed text-white rounded-lg font-label-md w-fit hover:opacity-90 transition-all">En savoir plus</button>
</div>
...
<p class="font-body-md text-on-surface-variant mt-xs italic">"Votre solde d'épargne pourrait générer 4% de rendement supplémentaire en étant réalloué."</p>
</div>
</div>
</section>
</main>
...
<a class="flex flex-col items-center justify-center text-primary font-bold transition-transform active:scale-90 tap-highlight-none" href="#">
<span class="material-symbols-outlined">home</span>
<span class="font-label-sm text-[10px]">Home</span>
</a>
<a class="flex flex-col items-center justify-center text-on-surface-variant transition-transform active:scale-90 tap-highlight-none" href="#">
...
<button class="fixed right-6 bottom-24 md:hidden w-14 h-14 bg-primary text-on-primary rounded-full shadow-2xl flex items-center justify-center z-40 active:scale-95 transition-all">
