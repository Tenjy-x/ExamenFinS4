...
<aside class="h-screen w-64 fixed left-0 top-0 hidden md:flex flex-col p-md gap-base bg-surface-container-lowest border-r border-outline-variant z-40">
<div class="mb-lg">
...
<a class="flex items-center gap-sm p-sm text-on-surface-variant hover:bg-surface-container-high transition-all rounded-lg" href="#">
...
<a class="flex items-center gap-sm p-sm bg-secondary-container text-on-secondary-container rounded-lg font-bold" href="#">
...
<a class="flex items-center gap-sm p-sm text-error hover:bg-error-container transition-all rounded-lg" href="#">
...
<input class="bg-transparent border-none focus:ring-0 text-body-md font-body-md w-48" placeholder="Rechercher..." type="text"/>
</div>
<div class="flex items-center gap-sm">
...
<div class="stats-gradient-1 p-md rounded-xl text-on-primary shadow-lg flex flex-col justify-between h-40 relative overflow-hidden group">
...
<span class="material-symbols-outlined absolute -right-4 -bottom-4 text-9xl opacity-10 group-hover:scale-110 transition-transform duration-500">payments</span>
</div>
...
<p class="font-body-md text-body-md text-outline">Configuration des frais fixes par tranche de montant.</p>
</div>
<button class="bg-primary text-on-primary px-md py-sm rounded-lg font-label-md text-label-md flex items-center gap-xs hover:opacity-90 transition-opacity">
...
<th class="px-md py-sm font-label-sm text-label-sm text-outline uppercase">Tranche Min (Ar)</th>
<th class="px-md py-sm font-label-sm text-label-sm text-outline uppercase">Tranche Max (Ar)</th>
<th class="px-md py-sm font-label-sm text-label-sm text-outline uppercase">Frais Fixe (Ar)</th>
<th class="px-md py-sm font-label-sm text-label-sm text-outline uppercase text-right">Actions</th>
</tr>
</thead>
...
<p class="font-body-md text-body-md text-outline">Gérez les codes opérateurs autorisés pour les transactions mobiles.</p>
<div class="space-y-sm">
<div class="flex items-center justify-between p-sm bg-surface-container-low rounded-lg border border-outline-variant/30">
<div class="flex items-center gap-sm">
<div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">33</div>
...
<div class="flex items-center justify-between p-sm bg-surface-container-low rounded-lg border border-outline-variant/30">
<div class="flex items-center gap-sm">
<div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">34</div>
...
<div class="flex items-center justify-between p-sm bg-surface-container-low rounded-lg border border-outline-variant/30">
<div class="flex items-center gap-sm">
<div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold">37</div>
...
<input class="flex-grow bg-surface-container-low border-none rounded-lg focus:ring-2 focus:ring-primary/20 font-body-md text-body-md py-sm" placeholder="ex: 032" type="text"/>
<button class="bg-secondary-container text-on-secondary-container px-md rounded-lg font-label-md text-label-md hover:bg-secondary-fixed transition-colors">
                                Ajouter
                            </button>
</div>
</div>
...
<p class="font-label-sm text-label-sm opacity-90">Les modifications des frais s'appliquent instantanément à toutes les nouvelles transactions. Pensez à notifier les clients via le panneau de communication.</p>
</div>
</div>
</div>
</main>
...
<button class="fixed bottom-20 right-6 md:bottom-8 md:right-8 w-14 h-14 bg-primary text-on-primary rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-transform z-40">
